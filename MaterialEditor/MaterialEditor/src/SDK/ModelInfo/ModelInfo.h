...
public:
	...
	virtual void				InitDynamicModels() const = 0;
	virtual void				ShutdownDynamicModels() const = 0;
	virtual void				AddDynamicModel(const char *name, int nModelIndex = -1) const = 0;
	virtual void				ReferenceModel(int modelindex) const = 0;
	virtual void				UnreferenceModel(int modelindex) const = 0;
	virtual void				CleanupDynamicModels(bool bForce = false) const = 0;
...
inline IVModelInfo *g_pModelInfo;